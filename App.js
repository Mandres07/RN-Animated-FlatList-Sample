...
const BG_IMG = 'https://images.pexels.com/photos/1231265/pexels-photo-1231265.jpeg?auto=compress&cs=';
   ...
   return (
      <SafeAreaView style={{ flex: 1 }}>
         <View style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <Animated.FlatList onScroll={Animated.event([{ nativeEvent: { contentOffset: { y: scrollY } } }], { useNativeDriver: true })}
               data={DATA} contentContainerStyle={{ padding: SPACING, paddingTop: StatusBar.currentHeight || 42 }} keyExtractor={item => item.key}
               renderItem={({ item, index }) => {
                  ...
                  return (
                     <Animated.View style={{
                        ...
                        shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.3, shadowRadius: 20, transform: [{ scale }], opacity
                     }}>
